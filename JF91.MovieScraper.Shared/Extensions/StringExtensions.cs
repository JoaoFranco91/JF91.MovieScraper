namespace JF91.MovieScraper.Shared.Extensions;

public static class StringExtensions
{
    public static string ToUniversalMovieTitle(this string input)
    {
        string universalMovieTitle = input;

        universalMovieTitle = universalMovieTitle.ToLower();
        universalMovieTitle = universalMovieTitle.Replace(" ", string.Empty);
        universalMovieTitle = universalMovieTitle.Replace(":", "-");
        universalMovieTitle = universalMovieTitle.Replace("/", "-");
        universalMovieTitle = universalMovieTitle.Replace(@"\", "-");
        universalMovieTitle = universalMovieTitle.Replace(">", "-");
        universalMovieTitle = universalMovieTitle.Replace("<", "-");
